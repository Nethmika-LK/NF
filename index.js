...
let up = `✅QUEEN X JANU-V1 CONNECTE SUCCESSFUL ✅\n\nPREFIX: ${prefix}`;
...
conn.sendFileUrl = async (jid, url, caption, quoted, options = {}) => {
	...
	//--------------------| Queen-x-janu Auto Voice |--------------------//

        if (config.AUTO_VOICE === "true") {
            let {
                data
            } = await axios.get("https://github.com/Shanu1126/AUTO-VOICE-SENDER-QUEEN-NETHU-MD-BOT/tree/main/plugins/bgm");
            for (vr in data) {
